...
DATASET_REGISTRY: Dict[str, List[DatasetComponent]] = {
    ...
    #     {
    #     "name": "detail_23k.json",        
    #     "extract": False,
    #     "url": "https://huggingface.co/datasets/liuhaotian/LLaVA-Instruct-150K/resolve/main/detail_23k.json",
    #     "do_rename": True,
    # },
    ]
}
...
if __name__ == "__main__":
    root_dir = Path(".")  # Define your root directory here
